...
test('sidepanel html exposes flow selector and kiro source fields', () => {
  ...
  [
    ...
    'id="row-grok-grok2api-url"',
    'id="input-grok-grok2api-url"',
    'id="row-grok-grok2api-username"',
    'id="input-grok-grok2api-username"',
    'id="row-grok-grok2api-password"',
    'id="input-grok-grok2api-password"',
    'id="row-grok-grok2api-upload-status"',
    'id="display-grok-grok2api-upload-status"',
...
const displayGrok2ApiUploadStatus = { textContent: '', title: '' };
const buttons = [];
